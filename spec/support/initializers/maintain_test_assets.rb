...
class MaintainTestAssets
  ...
  #
  ASSET_SOURCE_FOLDERS = [%w[app assets stylesheets], ['vendor']]
  ...
  #
  EXPECTED_ASSETS = %w[application.css]
  ...
  def self.maintain!
    ...
    #
    built_assets = EXPECTED_ASSETS.map { |leaf| Rails.root.join('app', 'assets', 'builds', leaf) }
